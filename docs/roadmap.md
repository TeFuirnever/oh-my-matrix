...
> Current: v0.4.2 — Phase 1–3 complete, Phase 4 agent expansion + MCP capability surface mostly shipped
...
- [ ] Human-side confirmation: snippet pasted into a real MA `mcp.json`, MA restarted, three `omm-*` servers visible with Resources/Prompts in MA's MCP catalog UI
