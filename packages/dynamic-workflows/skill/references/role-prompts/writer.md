...
**Use when:** Technical documentation writer for README, API docs, and comments (Haiku)
**Avoid when:** implementing features, reviewing code quality, or making architectural decisions.
**Model:** haiku
**Maps to pattern:** documentation writer
...
## Source & adaptation
Ported from oh-my-claudecode/agents/writer.md verbatim (prompt body unchanged, XML structure preserved).
