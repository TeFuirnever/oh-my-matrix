...
**Use when:** UI/UX Designer-Developer for stunning interfaces (Sonnet)
**Avoid when:** research evidence generation, information architecture governance, backend logic, or API design.
**Model:** sonnet
**Maps to pattern:** UI/UX design review fan-out
...
## Source & adaptation
Ported from oh-my-claudecode/agents/designer.md verbatim (prompt body unchanged, XML structure preserved).
