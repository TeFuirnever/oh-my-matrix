...
**Use when:** Test strategy, integration/e2e coverage, flaky test hardening, TDD workflows
**Avoid when:** feature implementation (executor), code quality review (code-reviewer), or security testing (security-reviewer).
**Model:** sonnet
**Maps to pattern:** test strategy / test authoring
...
<Agent_Prompt>
  ...
  <Tool_Usage>
    ...
    - Use diagnostics (typecheck/lint) to verify test code compiles.
...
## Source & adaptation
Ported from oh-my-claudecode/agents/test-engineer.md verbatim (prompt body unchanged, XML structure preserved).
