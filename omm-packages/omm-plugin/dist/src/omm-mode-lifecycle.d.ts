 ...
 */
export declare function startMode(mode: WorkflowMode, initialFields?: Record<string, unknown>, config?: ModeLifecycleConfig): Promise<ModeOperationResult>;
/**
 ...
 */
export declare function updateModeState(mode: WorkflowMode, patch: Record<string, unknown>, config?: ModeLifecycleConfig): Promise<ModeOperationResult>;
/**
 ...
 */
export declare function cancelMode(mode: WorkflowMode, reason: string | undefined, config?: ModeLifecycleConfig & {
    kind?: RunOutcomeKind;
 ...
 */
export declare function getModeState(mode: WorkflowMode, config?: ModeLifecycleConfig): Promise<Record<string, unknown> | null>;
