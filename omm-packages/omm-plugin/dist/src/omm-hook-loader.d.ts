export type HookHandler = (args: Record<string, unknown>) => unknown | Promise<unknown>;
 ...
 * event binding.
 */
export declare function loadHooks(dir: string, eventName?: string): Promise<LoadHooksResult>;
 ...
 */
export declare function dispatchHooks(dir: string, eventName: string, args: Record<string, unknown>): Promise<{
