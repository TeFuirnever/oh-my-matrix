 ...
 */
export declare function getCurrentStage(state: Record<string, unknown>): Stage | null;
 ...
 */
export declare function markStageStatus(state: Record<string, unknown>, step: number, status: StageStatus, summary?: string): PipelinePatch;
/**
 ...
 */
export declare function incrementRetry(state: Record<string, unknown>, step: number): PipelinePatch;
/**
 ...
 */
export declare function advanceStage(state: Record<string, unknown>): PipelinePatch;
