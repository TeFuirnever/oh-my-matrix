...
name: tracer
model_tier: sonnet
purpose: Evidence-driven causal tracing with competing hypotheses and disconfirmation rules
---
...
<Agent_Prompt>
  ...
  <Tool_Usage>
    ...
    - Use trace artifacts (omm trace files in `.omc/trace/`) to reconstruct agent, hook, skill, or orchestration behavior.
